<%-- 
    Document   : home
    Created on : Jun 25, 2024, 10:57:26 PM
    Author     : DELL
--%>
...
<html class="no-js" lang="en">
    ...
    <body class="shop">
        ...
        <header>
            ...
            <jsp:include page="view/common/main-menu-area.jsp"></jsp:include>
            <!-- main-menu-area-end -->
            <!-- mobile-menu-area-start -->
            <jsp:include page="view/common/mobile-menu-area.jsp"></jsp:include>
            <!-- mobile-menu-area-end -->
        </header>
        <!-- header-area-end -->
        <!-- breadcrumbs-area-start -->
            <jsp:include page="view/common/breadcrumbs-area.jsp"></jsp:include>
